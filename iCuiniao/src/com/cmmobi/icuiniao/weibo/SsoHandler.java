...
//    private String[] mAuthPermissions;
    ...
    public SsoHandler(Activity activity,Weibo weibo,final Handler handler) {
        ...
        conn = new ServiceConnection() {
            ...
            public void onServiceDisconnected(ComponentName name) {
                mWeibo.startAuthDialog(mAuthActivity, mAuthDialogListener,mhandler);
            }
...
//                        startDialogAuth(mAuthActivity, new String[]{});
                        mWeibo.startAuthDialog(mAuthActivity, mAuthDialogListener,handler);
                    }
     ...
     */
    public void authorize( final WeiboAuthListener listener,Handler handler) {
        authorize( DEFAULT_AUTH_ACTIVITY_CODE,
                listener,handler);
    }

    private void authorize(
            int activityCode, final WeiboAuthListener listener,Handler handler) {
