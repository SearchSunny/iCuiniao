...
public class StatusesAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void upload( String content, String file, String lat, String lon,String annotations,
			RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("status", content);
		params.add("pic", file);
		...
		if(!TextUtils.isEmpty(annotations.toString())){
			
			params.add("annotations", annotations.toString());
		}
