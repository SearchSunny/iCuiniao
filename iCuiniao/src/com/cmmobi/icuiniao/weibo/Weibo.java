...
public class Weibo {
	...
	public static String app_key = "1506136685";//第三方应用的appkey
	public static String redirecturl = "http://jumpcn.icuiniao.com/Approve/login/redirect";// 重定向url
	 ...
	 */
	public void authorize(Context context, WeiboAuthListener listener,Handler handler) {
		isWifi=Utility.isWifi(context);
		startAuthDialog(context, listener,handler);
	}

	public void startAuthDialog(Context context, final WeiboAuthListener listener,Handler handler) {
...
//		CookieSyncManager.createInstance(context);
	...
	public void startDialog(Context context, WeiboParameters parameters,
			final WeiboAuthListener listener,Handler handler) {
		...
		if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			...
			new WeiboDialog(context, url, listener,handler).show();
		}
	}
